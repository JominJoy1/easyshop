...
public class Offerdetails extends AppCompatActivity implements JsonResponse{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JR.json_response = (JsonResponse) Offerdetails.this;
        String q = "/placed?product_id=" + Userhome.post_id;
        q = q.replace(" ", "%20");
        JR.execute(q);



        String pth = "http://"+sh.getString("ip", "")+"/"+ Offerdetails.am;
        pth = pth.replace("~", "");
