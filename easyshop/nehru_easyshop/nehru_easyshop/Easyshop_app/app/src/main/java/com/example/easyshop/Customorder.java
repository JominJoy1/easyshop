...
public class Customorder extends ArrayAdapter<String>  {
    ...
    public Customorder(Activity context, String[] file, String[] post,String[] details,String[] price) {
        //constructor of this class to get the values from main_activity_class

        super(context, R.layout.activity_customorder, file);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.activity_customorder, null, true);
